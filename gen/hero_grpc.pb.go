...
func RegisterHeroesServiceServer(s *grpc.Server, srv HeroesServiceServer) {
	s.RegisterService(&_HeroesService_serviceDesc, srv)
}
...
var _HeroesService_serviceDesc = grpc.ServiceDesc{
